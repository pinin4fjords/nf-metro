...
[contributing.md](docs/contributing.md) for the `purpose`/flag options). The
...
| Routing   | `src/nf_metro/layout/routing/` | Edge routing (horizontal runs + 45-degree diagonals; L-shaped inter-section). `core.py` is a thin first-match dispatcher over handler families in sibling modules; `invariants.py` checks output every render.                                                                                                                                                                                                                      | `docs/dev/routing.mdx`; inter-section dispatch table in `docs/dev/inter_section_dispatch.md`      |
