...
| `disconnected_components_fold.mmd`      | disconnected components under folding / grid rows renormalised to physical stack order so the inter-row cascade keeps the wide standalone section clear of the folded trunk (issue #1164) |
