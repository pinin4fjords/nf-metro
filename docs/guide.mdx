...
| `%%metro stroke_scale: <factor>`                                           | Scale track stroke weight, station pill size, and label halos, widening bundle spacing and marker clearance to match (`1.0` = default). Counteracts the downscale a large map takes to fit a fixed screen                                                                                                                                                                                              |
