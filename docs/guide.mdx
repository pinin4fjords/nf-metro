...
| `%%metro logo: <path>`                                                     | Logo image, bundled into the legend (or top-left if there is no legend). The path is resolved relative to the `.mmd` file's directory. An unresolvable path emits a warning and omits the logo (use `--logo` if you need a hard error).                                                                                                                                                                |
