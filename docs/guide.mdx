...
<Code
  code={fanInMergeMmd}
  lang="metro"
  title="examples/guide/03b_fan_in_merge.mmd"
/>
...
<Code
  code={directionsMmd}
  lang="metro"
  title="examples/guide/04_directions.mmd"
/>
...
<Code
  code={fileIconsMmd}
  lang="metro"
  title="examples/guide/05_file_icons.mmd"
/>
...
<Code
  code={withoutHiddenMmd}
  lang="metro"
  title="examples/guide/06a_without_hidden.mmd"
/>
