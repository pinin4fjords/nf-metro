...
| `%%metro stroke_scale: <factor>`                                           | Scale track stroke weight and station pill size, widening bundle spacing, marker clearance, and rail pitch to match (`1.0` = default). Counteracts the downscale a large map takes to fit a fixed screen                                                                                                                                                                                               |
