...
import variantCallingMmd from "@examples/variant_calling.mmd?raw";
import variantCallingTunedMmd from "@examples/variant_calling_tuned.mmd?raw";
...
<Code code={variantCallingMmd} lang="metro" title="examples/variant_calling.mmd" />
...
<Code code={variantCallingTunedMmd} lang="metro" title="examples/variant_calling_tuned.mmd" />
