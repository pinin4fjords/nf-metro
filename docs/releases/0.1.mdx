...
<Metro src="examples/guide/05_file_icons.mmd" mmd={false} />
...
<Metro src="examples/guide/01_minimal.mmd" mmd={false} />

<Metro src="examples/guide/02_sections.mmd" mmd={false} />

<Metro src="examples/guide/03_fan_out.mmd" mmd={false} />
