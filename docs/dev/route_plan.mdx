...
| [#1660](https://github.com/seqeralabs/nf-metro/issues/1660) | Planned     | Final row and column allocation, realising demands through monotone envelope settlement |
...
[#1660](https://github.com/seqeralabs/nf-metro/issues/1660) owns the shared row
and column settlement needed to absorb those cases. Once that allocation is
available, [#1658](https://github.com/seqeralabs/nf-metro/issues/1658) owns
removal of the displaced compatibility emission and repair machinery. A
compatibility diagnostic therefore records a specific missing capability,
rather than acting as an open-ended fallback for an unfamiliar topology.
