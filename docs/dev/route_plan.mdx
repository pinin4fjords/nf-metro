...
badge it cannot clear, still fires 158 times across 14 fixtures -- every one of
them at a gap the ledger never claimed, so there is no reservation to consume
there. Where a reservation does exist the fallback is gone: 160 of 161 realised
