...
changes. Thirteen of the corpus's fourteen compatibility systems do not change at
any capacity up to 4464px, which is what proves their limit is a channel decision
rather than envelope allocation. One, `merge_around_below_leftmost`, does change,
and is the reason the settlement work is not finished.
