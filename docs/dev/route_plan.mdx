...
[#1712](https://github.com/seqeralabs/nf-metro/issues/1712) carries the boundary
grant that would make the room. Historical population and grant totals from the
measurement programme are recorded in the
[envelope settlement design record](/nf-metro/dev/layout_settlement_design_record/).
