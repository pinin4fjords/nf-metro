...
- **Stage 4.8**: Align trunk Ys across same-row sections. Shifts
  ...
  A row whose sections carry different through-lines levels the stretches
  that agree rather than the whole row, and only where a section is
  caught between two lanes -- its own through-line arriving and leaving
  at different Ys.
