...
| 6   | `BOTTOM entry L-shape`               | `entry_side is BOTTOM`                                                                  | `_route_bottom_entry_l_shape`, the mirror-image handler. Same reason as rule 5: the same-X rule would drop straight in with no horizontal lead-in.                                                                                                                |
| 7   | `same-X vertical drop`               | `same_x`                                                                                | straight vertical                                                                                                                                                                                                                                                 |
| 8   | `bottom-exit junction`               | source is a bottom-exit junction                                                        | `_route_bottom_exit_junction`                                                                                                                                                                                                                                     |
| 9   | `bypass family`                      | `needs_bypass`                                                                          | `_route_bypass_family`: merge trunk/branch, LEFT-entry-one-row-below straight drop, RIGHT-entry wrap (gap-above or around-below), else the U-shaped bypass                                                                                                        |
| 10  | `near-vertical same-col junction`    | junction dropping almost straight into a same-column entry                              | `_route_near_vertical_junction`                                                                                                                                                                                                                                   |
| 11  | `RIGHT entry wrap`                   | `entry_side is RIGHT` and travelling right                                              | `_route_right_entry_wrap` (over the top / around the right side)                                                                                                                                                                                                  |
| 12  | `LEFT entry wrap family`             | `entry_side is LEFT`, `dx < 0`, `cross_row`                                             | `_route_left_entry_family`: inter-row gap wrap, or the corridor / around-below loop when that gap crosses a section                                                                                                                                               |
| 13  | `serpentine LEFT exit -> LEFT entry` | LEFT exit into a LEFT entry stacked in the same column                                  | `_route_left_exit_left_entry_drop`                                                                                                                                                                                                                                |
| 14  | `merge entry family`                 | `merge_ep is not None`                                                                  | `_route_merge_entry_family`: straight (near-collinear), corridor / around-below (LEFT entry crossing a section), else L-shape into the entry port                                                                                                                 |
| 15  | `RIGHT entry plough -> bypass`       | a higher-row L-shape to a RIGHT entry that would plough an intervening same-row section | `_route_bypass`                                                                                                                                                                                                                                                   |
