...
See the router contract in [route_plan](route_plan.mdx#the-routers-side-of-the-contract).
...
| `reserved_bands.py`         | realised row-gap corridor bands read off a `RouteReservation` ledger (`build_reserved_row_bands`, `ReservedRowBands`)                                                                                                                     |
