...
See [Parser](../parser/) for the directive model and the
...
See [Layout pipeline](../layout_pipeline/) for the full phase-by-phase
walkthrough and [Routing](../routing/) for the route families.
