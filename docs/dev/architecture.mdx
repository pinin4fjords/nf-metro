...
<CardGrid>
  <LinkCard title="Layout pipeline" href="/nf-metro/dev/layout_pipeline/" description="Phase-by-phase walkthrough of how coordinates are assigned." />
  <LinkCard title="Routing" href="/nf-metro/dev/routing/" description="Edge routing families, dispatch order, bundles, and runtime guards." />
  <LinkCard title="Parser" href="/nf-metro/dev/parser/" description="The Lark grammar, directive model, and post-parse rewrites." />
  <LinkCard title="Render" href="/nf-metro/dev/render/" description="SVG, HTML, bridges, manifest, legend, and animation." />
  <LinkCard title="Inter-section dispatch" href="/nf-metro/dev/inter_section_dispatch/" description="The declarative dispatch table for inter-section route shapes." />
  <LinkCard title="Routing gate coverage" href="/nf-metro/dev/routing_gate_coverage/" description="Auto-generated matrix of which handler arms are exercised by the corpus." />
  <LinkCard title="Routing gate triage" href="/nf-metro/dev/routing_gate_triage/" description="Process for triaging un-exercised or needs-review gate arms." />
  <LinkCard title="Testing" href="/nf-metro/dev/testing/" description="Test structure, the four validation layers, and adding fixtures." />
</CardGrid>

The per-phase preconditions, postconditions, and invariants are in [`CONTRACT.md`](https://github.com/pinin4fjords/nf-metro/blob/main/src/nf_metro/layout/CONTRACT.md). The topology stress fixture inventory is in [`examples/topologies/README.md`](https://github.com/pinin4fjords/nf-metro/blob/main/examples/topologies/README.md).
