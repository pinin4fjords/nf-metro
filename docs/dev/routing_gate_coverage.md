...
**2238/3179** gates fully exercised (both/all arms hit by some fixture); **941** gates have at least one un-exercised arm.
...
| 4400 | `if any(line_id not in ctx.line_priority for line_id in present):` | `->L4401` |  |
