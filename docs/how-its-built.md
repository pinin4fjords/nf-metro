...
- [`architecture.md`](/nf-metro/dev/architecture/) - system overview and data flow
- [`layout_pipeline.md`](/nf-metro/dev/layout_pipeline/) - the phase sequence with entry/exit contracts
- [`routing.md`](/nf-metro/dev/routing/) - edge routing mechanics and the centreline/offset model
- [`inter_section_dispatch.md`](/nf-metro/dev/inter_section_dispatch/) - the dispatch table for inter-section routes
- [`routing_gate_coverage.md`](/nf-metro/dev/routing_gate_coverage/) - which handler arms are covered by corpus tests
- [`parser.md`](/nf-metro/dev/parser/) - the Lark grammar and post-parse rewrites
