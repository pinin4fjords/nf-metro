...
_KNOWN_END_OF_LAYOUT_GAPS: dict[str, frozenset[str]] = {
    ...
    "topologies/bypass_v_tight": frozenset({"4.7"}),
    "topologies/compact_gap_peer_conflict": frozenset({"4.7"}),
    "topologies/fan_branch_additional_outputs": frozenset({"4.7"}),
    "topologies/fanout_hub_two_line_trunk": frozenset({"4.7"}),
    "topologies/foldback_exit_peeloff": frozenset({"4.7"}),
    "topologies/internal_source_equal_sibling_2fan": frozenset({"4.7"}),
    "topologies/junction_entry_collision": frozenset({"4.7"}),
    "topologies/manual_rl_row_nonconsumer_bypass": frozenset({"4.7"}),
    ...
    "topologies/packed_cell_cellmate_bypass": frozenset({"4.7"}),
